 ...
 */
public abstract class FileStoreClient extends SubCommand {
    ...
    public List<org.apache.ratis.examples.filestore.FileStoreClient> getClients(RaftProperties raftProperties) {
        List<org.apache.ratis.examples.filestore.FileStoreClient> fileStoreClients = new ArrayList<>();
        for (int i = 0; i < numClients; i++) {
            ...
            fileStoreClients.add(new org.apache.ratis.examples.filestore.FileStoreClient(client));
        }
    ...
    protected void stop(List<org.apache.ratis.examples.filestore.FileStoreClient> clients) throws IOException {
        for (org.apache.ratis.examples.filestore.FileStoreClient client : clients) {
            client.close();
        }
        System.exit(0);
    }
    ...
    protected abstract void operation(List<org.apache.ratis.examples.filestore.FileStoreClient> clients) throws Exception;
}
